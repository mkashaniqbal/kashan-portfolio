  ...
  return (
    <html lang="en" className="scroll-smooth">
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `
              ...
              })(window,document,'script','dataLayer','GTM-PJVVFJPH');
            `,
          }}
        />
        {/* Google Analytics */}
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-QBB1WQR141"></script>
        <script
          dangerouslySetInnerHTML={{
            __html: `
      ...
      <body>
        ...
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-PJVVFJPH"
            height="0"
            width="0"
